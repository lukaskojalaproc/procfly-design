...
const kpiByPeriod: Record<Period, Kpi[]> = {
  month: [
    { key: "spend",        label: "Total Spend",       value: "€1,100,000",  sub: "committed spend",      delta: 12.4, trend: "up",   goodWhen: "down" },
    { key: "savings",      label: "Savings Achieved",  value: "€84,000",     sub: "vs baseline target",   delta: 8.1,  trend: "up",   goodWhen: "up"   },
  ...
  quarter: [
    { key: "spend",        label: "Total Spend",       value: "€2,700,000",  sub: "committed spend",      delta: 9.2,  trend: "up",   goodWhen: "down" },
    { key: "savings",      label: "Savings Achieved",  value: "€231,000",    sub: "vs baseline target",   delta: 11.5, trend: "up",   goodWhen: "up"   },
  ...
  year: [
    { key: "spend",        label: "Total Spend",       value: "€10,700,000", sub: "committed spend",      delta: 5.8,  trend: "up",   goodWhen: "down" },
    { key: "savings",      label: "Savings Achieved",  value: "€912,000",    sub: "vs baseline target",   delta: 17.3, trend: "up",   goodWhen: "up"   },
